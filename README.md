...
```bash
curl -fsSL https://raw.githubusercontent.com/tavongamatikiti/dev/v1.0.6/install-mac.sh | bash -s -- --ref v1.0.6
curl -fsSL https://raw.githubusercontent.com/tavongamatikiti/dev/v1.0.6/install-ubuntu.sh | bash -s -- --ref v1.0.6
```

Replace `v1.0.6` with the release tag. The curl bootstrap refuses to overwrite an existing `~/Developer/dev` folder.
